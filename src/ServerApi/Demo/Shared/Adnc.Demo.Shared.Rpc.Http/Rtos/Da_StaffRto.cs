...
{  
    ...
    /// 岗位
    /// </summary>
    public long PostNameID { get; set; } = 0;
    ...
    /// 暂扣金额
    /// </summary>
    public decimal DurationaMount { get; set; } = 0;
...
public class Da_Staff_ServiceRto
{
...
public class Da_StaffListDto
{
    ...
    /// 姓名（别名）
    /// </summary>
    public string StaffName_Alias { get; set; } = string.Empty;
    /// <summary> 
    /// 性别
    /// </summary>
